...
export const CARD_SETS: Record<Locale, Record<SoundKey, SoundCard>> = {
  ru: {
    L: {
      ...shared.L,
      name: 'лев',
      image: '/images/speech-cards/lion.png',
      tongueTip: 'Кончик языка подними к верхним зубкам.',
    },
    R: {
      ...shared.R,
      name: 'ракета',
      image: '/images/speech-cards/rocket.png',
      tongueTip: 'Улыбнись и дай язычку легко задрожать.',
    },
    SH: {
      ...shared.SH,
      name: 'шар',
      image: '/images/speech-cards/balloon.png',
      tongueTip: 'Губы округли, язык сделай широкой чашечкой.',
    },
  },
  kz: {
    L: {
      ...shared.L,
      name: 'лақ',
      image: '/images/speech-cards/goat-kz.png',
      tongueTip: 'Тілдің ұшын жоғарғы тістерге жақындат.',
    },
    R: {
      ...shared.R,
      name: 'ара',
      image: '/images/speech-cards/bee-kz.png',
      tongueTip: 'Жымиып, тілдің ұшын жеңіл дірілдет.',
    },
    SH: {
      ...shared.SH,
      name: 'шар',
      image: '/images/speech-cards/balloon.png',
      tongueTip: 'Ерінді дөңгелетіп, тілді кең ұста.',
    },
  },
};
